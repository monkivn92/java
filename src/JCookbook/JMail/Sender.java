...
public class Sender
{
    ...
    protected String message_recip = "gin@yopmail.com";

    /* What's it all about, Alfie? */
    protected String message_subject = "Re: your mail";
    /** The message CC recipient. */
    protected String message_cc = "vuongpv@yopmail.com";
    /** The message body */
    ...
    public void doSend()
    {
        ...
        props.put("mail.smtp.user", "kyle@patientcrossroads.com");
        ...
        Authenticator auth = new Authenticator() {
            ...
            {
                return new PasswordAuthentication("kyle@patientcrossroads.com", "*****");
            }
        };
        ...
        try
        {
            ...
            mesg.setFrom(new InternetAddress("java@host.domain"));
