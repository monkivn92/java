...
class Menu2Frame extends Frame
{
    String msg = "";
    CheckboxMenuItem debug, test;

    Menu2Frame(String title)
    {
        super(title);
        ...
        MyMenu2Handler handler = new MyMenu2Handler(this);
        ...
        MyWindow333Adapter adapter = new MyWindow333Adapter(this);
        // register it to receive those events
...
class MyWindow333Adapter extends WindowAdapter
{
    Menu2Frame menuFrame;
    public MyWindow333Adapter(Menu2Frame menuFrame)
    {
...
class MyMenu2Handler implements ActionListener, ItemListener
{
    Menu2Frame menuFrame;
    public MyMenu2Handler(Menu2Frame menuFrame)
    {
        this.menuFrame = menuFrame;
    }
